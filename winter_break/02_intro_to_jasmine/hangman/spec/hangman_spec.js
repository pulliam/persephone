describe('hangman', function(){
  ...
  xdescribe('hangman.set(word)', function(){
  ...
  xdescribe('hangman.includes(letter)', function(){
  ...
  xdescribe('hangman.reveal(letter)', function(){
  ...
  xdescribe('hangman.new(word)', function(){
  ...
  xdescribe('hangman.guess(letter)', function(){
